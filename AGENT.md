# Cargo from China — Agent Implementation Guide
...
## Project: Cargo from China
**Primary goal:** streamline customs clearance for Chinese imports
**Problem being solved:** complex customs clearance process for Chinese imports
**Target users:** importers, buyers of Chinese goods
**Pages:** Home
**Sections:** Hero, Automated calculation of duties and taxes for imports, Automated HS code lookup for accurate duty calculation, Who it is for, Primary call to action
**Features:** Automated calculation of duties and taxes for imports, Automated HS code lookup for accurate duty calculation, Responsive layout
